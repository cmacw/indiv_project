...
def run_one_set(dataset):
    # Train one set only
    trainset_info = {"path": "Debug/Train", "dataset_name": dataset, "cam_id": 0,
                     "image_name": "image_t_{}_cam_{}.png",
                     "pos_file_name": dataset+"_cam_pos.csv",
                     "ndata": 10000, "epochs": 100, "batch_size": 32}

    testset_info = {"path": "Debug/Test", "dataset_name": dataset + "_test", "cam_id": 0,
                    "image_name": "image_t_{}_cam_{}.png",
                    "pos_file_name": dataset+"_cam_pos_test.csv",
                    "ndata": 1000}
